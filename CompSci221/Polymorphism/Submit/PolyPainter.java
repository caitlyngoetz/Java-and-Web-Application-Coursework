...
public class PolyPainter extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e) {
		...
		shapes[0] = new SquareThing(rand.nextInt(width), rand.nextInt(height), rand.nextInt(width), rand.nextInt(height));
		shapes[1] = new LineThing(rand.nextInt(width), rand.nextInt(height), rand.nextInt(width), rand.nextInt(height));
		shapes[2] = new OvalThing(rand.nextInt(width), rand.nextInt(height), rand.nextInt(width), rand.nextInt(height));
		shapes[3] = new FilledOvalThing(rand.nextInt(width), rand.nextInt(height), rand.nextInt(width), rand.nextInt(height));
